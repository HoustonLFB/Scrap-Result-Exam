...
bddSql.sqlExecute("DELETE FROM `examen` WHERE 1")
...
def txtToArray():
    ...
    fichier = open('franceBacLinks.txt', 'r')
...
for url in urls:
    ...
    for eleve in eleves:
        ...
        sqlInsert = f"INSERT INTO `examen`(`nom_entier`, `résultat`, `academie`, `ville`, `examen`, `annee_session`, `etranger`) VALUES (%s, '{resultat}', '{academie}', %s, 'BACCALAUREAT_GENERAL','2023', 0);"
