...
def txtToArray():
    ...
    fichier = open('franceBacTLinks.txt', 'r')
...
for url in urls:
    ...
    for eleve in eleves:
        ...
        sqlInsert = f"INSERT INTO `bac_techno`(`nom_entier`, `résultat`, `academie`, `ville`, `examen`, `specialite`, `annee_session`) VALUES (%s, '{resultat}', '{academie}', %s, 'BACCALAURÉAT_TECHNOLOGIQUE', '{serie}', '2023');"
